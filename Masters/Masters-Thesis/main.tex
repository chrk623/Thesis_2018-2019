...
\thesistitle{Visualising Data Wrangling Operations: \\ Joins and Reshaping} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{\href{https://www.stat.auckland.ac.nz/people/amar112}{Anna \textsc{Fergusson}} \\ Chris \textsc{Wild}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\emph{Supervisors:} \\
\href{https://www.stat.auckland.ac.nz/people/cwil119}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
 
\includegraphics[scale=0.08]{img/uoalogo.png}
...
In the recent update of \href{https://www.stat.auckland.ac.nz/~wild/iNZight/}{\textbf{iNZight}}, a joining and reshaping module was introduced. This module provides a tool for users to join and reshape data sets. Though it is not difficult to apply these operations and obtain the result with a tool like \textbf{iNZight}, there is a lack of tutorials or tools that explain the underlying process of these operations in an easy to understand manner. In this report, why these data operations are useful and important will be discussed. Software will also be developed that attempts to teach key concepts associated with joining and reshaping data sets through animations.
